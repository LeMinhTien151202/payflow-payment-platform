...
import com.payflow.ledger.application.outbox.OutboxBatchResult;
import com.payflow.ledger.application.outbox.OutboxPublishPolicy;
import com.payflow.ledger.application.port.OutboxLeaseStore;
import com.payflow.ledger.application.port.OutboxTransport;
...
class PublishOutboxHandlerTest {
    ...
    private static final String OWNER = "ledger-service:publisher-1";
