...
| --- | --- | --- |
| [adr/](adr/README.md) | ADR chính thức | ADR-004, ADR-007, ADR-011–ADR-020 (các ID có file) `ACCEPTED` |
...
| [events/](events/refund-requested-v1.md) | Kafka event contract | Payment Saga và refund intake events v1 |
